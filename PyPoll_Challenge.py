...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_list:
        ...
        county_percentage = float(votes_of_county) / float(total_votes) * 100
        county_results = (
            f"{county_name}: {county_percentage:.1f}% ({votes_of_county:,})\n")
        ...
        if(votes_of_county > largest_turnout_number):
            largest_turnout_number = votes_of_county
